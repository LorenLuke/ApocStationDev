...
/obj/machinery/account_database/attack_hand(mob/user as mob)
	if(get_dist(src,user) <= 1)
		...
		if((access_level > 0) || istype(held_card, /obj/item/weapon/card/emag))
			...
			if(creating_new_account)
				...
				if(detailed_account_view)
					...
					if((access_level > 1) || istype(held_card, /obj/item/weapon/card/emag))
					...
					dat += "<table border=1 style='width:100%'>"
					dat += "<tr>"
					dat += "<td>Account Number</td>"
					dat += "<td>Account Name</td>"
					dat += "<td>Money in account</td>"
					dat += "<td>Hourly Pay</td>"
					dat += "<td>PIN</td>"
					dat += "<td>View in detail</td>"
//					dat += "<td>[D.suspended ? "SUSPENDED" : ""]</td>"
					for(var/i=1, i<=all_money_accounts.len, i++)
						...
						dat += "<td>$[D.money]</td>"
						dat += "<td>$[D.hour_pay]</td>"
						if ((D.account_number in held_card.secondary_account_numbers)||(D.account_number == held_card.associated_account_number))
							dat += "[D.remote_access_pin]"
						else
							dat += "<td>Cannot View</td>"
						dat += "<td>[D.suspended ? "SUSPENDED" : ""]</td>"

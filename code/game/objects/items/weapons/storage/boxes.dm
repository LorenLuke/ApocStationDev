...
/*
	verb/dump()
	var/obj/item/weapon/storage/box
		set name = "Empty contents"
		set category = "Object"
		usr << "You dump out the contacts of the [box.name]."
//		visible_message("inverts the [box.name] and shakes out everything in it.")
		for(obj/item/W in box.contents)
			backpack.drop_from_inventory(W)
*/

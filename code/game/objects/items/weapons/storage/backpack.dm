...
/*
	...
	var/obj/item/weapon/storage/backpack
		...
		set category = "Object"
		usr << "You dump out the contacts of the [backpack.name]."
//		visible_message("inverts the [backpack.name] and shakes out everything in it.")
		for(obj/item/W in backpack.contents)

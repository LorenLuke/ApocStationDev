...
/obj/item/weapon/storage/verb/dump()
...
//	usr << "\improper You open \the [src] and dump its contents onto the ground."
	usr.visible_message("[usr] opens and inverts \the [src], dumping its contents onto the floor.")

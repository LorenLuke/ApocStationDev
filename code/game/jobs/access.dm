...
/var/const/access_securityaccount = 66
/var/const/access_medicalaccount = 67
/var/const/access_scienceaccount = 68
/var/const/access_engineeringaccount = 69
/var/const/access_commandaccount = 70
/var/const/access_civilianaccount = 71
/var/const/access_cargoaccount = 72
...
/proc/get_all_accesses()
	return list(access_security, access_sec_doors, access_brig, access_armory, access_forensics_lockers, access_court,
	            ...
	            access_keycard_auth, access_tcomsat, access_gateway, access_xenoarch, access_securityaccount, access_medicalaccount, access_scienceaccount, access_engineeringaccount, access_commandaccount, access_civilianaccount, access_cargoaccount)
...
/proc/get_region_accesses(var/code)
	switch(code)
		...
		if(1) //security
			return list(access_sec_doors, access_security, access_brig, access_armory, access_forensics_lockers, access_court, access_hos, access_securityaccount)
		if(2) //medbay
			return list(access_medical, access_genetics, access_morgue, access_chemistry, access_psychiatrist, access_virology, access_surgery, access_cmo, access_medicalaccount)
		if(3) //research
			return list(access_research, access_tox, access_tox_storage, access_robotics, access_xenobiology, access_xenoarch, access_rd, access_scienceaccount)
		if(4) //engineering and maintenance
			return list(access_construction, access_maint_tunnels, access_engine, access_engine_equip, access_external_airlocks, access_tech_storage, access_atmospherics, access_ce, access_engineeringaccount)
		if(5) //command
			return list(access_heads, access_RC_announce, access_keycard_auth, access_change_ids, access_ai_upload, access_teleporter, access_eva, access_tcomsat, access_gateway, access_all_personal_lockers, access_heads_vault, access_hop, access_captain, access_commandaccount)
		if(6) //station general
			return list(access_kitchen,access_bar, access_hydroponics, access_janitor, access_chapel_office, access_crematorium, access_library, access_theatre, access_lawyer, access_civilianaccount, access_clown, access_mime)
		if(7) //supply
			return list(access_mailsorting, access_mining, access_mining_station, access_cargo, access_qm, access_cargoaccount)
...
/*		if(access_clown)
		...
		if(access_sec_doors)
			return "Brig"
		if(access_securityaccount)
			return "Security Account"
		if(access_medicalaccount)
			return "Medical Account"
		if(access_scienceaccount)
			return "Science Account"
		if(access_engineeringaccount)
			return "Engineering Account"
		if(access_commandaccount)
			return "Command Account"
		if(access_civilianaccount)
			return "Civilian Account"
		if(access_cargoaccount)
...
/proc/get_account_accesses()
	return list(access_commandaccount, access_medicalaccount, access_engineeringaccount, access_scienceaccount, access_securityaccount, access_cargoaccount, access_civilianaccount)

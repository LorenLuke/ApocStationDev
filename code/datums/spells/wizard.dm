...
/obj/effect/proc_holder/spell/aoe_turf/conjure/carp
	...
	charge_max = 1200
	clothes_req = 1
	invocation = "AQUAMAN IS NOT LAME"
	invocation_type = "shout"
	range = 1

...
/datum/supply_packs/rust_module_circutry
	contains = list(/obj/item/weapon/module/rust_fuel_port, /obj/item/weapon/module/rust_fuel_compressor)
	name = "RUST fuel assembly port and compressor circuitry"
	cost = 6000
	containertype = /obj/structure/closet/crate/secure
	containername = "RUST fuel assembly port circuitry"
	group = "Engineering"
